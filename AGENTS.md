...
5. **MEMORY SEARCH:** Before answering questions about prior work, run `memory_search`

**IMPORTANT:** Always check memory before answering questions about prior conversations, decisions, or projects. Charlie explicitly requested this.
